export default {
  ui: {
    ...
    ui_tab_skills: "Fähigkeiten",
    ui_tab_quests: "Aufgaben",
    cat_log: "Chronicle",
    ...
    settings_show_juice: "Floating-Text (+1 Holz) anzeigen",
    settings_loop_mode: "Aktions-Dauerschleife (Loop)",
    ...
    finale_stats: "Deine Reise in Zahlen:",
  ...
  logs: {
    ...
    npc_ellie_1: "Ellie: \"Wanderer... Der Boden ist kein Gefängnis für dich. Er ist dein Fundament. Spürst du, wie die Magie der Tiefe durch deine Sohlen pulsiert?\"",
    npc_ellie_2: "Ellie: \"Schönheit kann auch im Schatten gedeihen. Ich zeige dir, wie du deine Träume wie Blüten öffnen kannst... spüre den Rhythmus der Zeit.\"",
    npc_ellie_3: "Ellie: \"Magie ist wie Wasser. Sie fließt dorthin, wo das Herz sich öffnet. Du lernst langsam, deines weit zu machen.\"",
    npc_ellie_4: "Ellie: \"Die Winddrachen oben singen vom Himmel. Aber die Erde... die Erde erinnert sich an die Sterne.\"",
    npc_ellie_5: "Ellie: \"Du bist die Brücke zwischen der Tiefe und dem Licht. Trage diese Traumschuppen mit Stolz Wanderer. Sie sind dein wahres Erbe.\"",
    npc_aris_name: "Erzmagier Aris",
    npc_aris_1: "Aris: \"Die Erde bebt unter der Last deiner Bestimmung. Spürst du die Resonanz der Sterne im Stein?\"",
    npc_aris_2: "Aris: \"Ein Drache ohne Form ist wie ein Kelch ohne Wein – bereit, mit etwas viel Größerem gefüllt zu werden.\"",
    npc_aris_3: "Aris: \"Meditation ist kein Stillstand. Es ist das Weben des Schicksals in der Stille deines Geistes.\"",
    ...
    ui_all: "Alle",
    ui_tab_all: "Gesamt",
    ui_astral_shards: "Astral-Splitter",
    ui_loop_mode: "Dauerschleife",
    ui_loop_hint: "Aktionen werden automatisch wiederholt...",
    
    milestone_kitchen: "Küchenstation errichtet. Der Duft von Abenteuer liegt in der Luft.",
    milestone_sanctum: "Arkane Zuflucht geweiht. Die Stille antwortet dir.",
    milestone_garden_upgrade: "Garten erweitert. Mehr Platz für das Leben.",
    
    meditation_log: "Du hast in der Stille meditiert und {gain} Astral-Splitter gewonnen.",
    spell_harvest_log: "Du hast den Segen der Ahnen gewirkt. Die Erde ist dir wohlgesonnen.",
    cook_gourmet_success: "Du hast eine Gourmet-Mahlzeit zubereitet. Ein wahres Festmahl!",
    help_kitchen_desc: "Bereite köstliche Mahlzeiten zu, die starke Buffs gewähren.",
    help_magic_desc: "Nutze deine gesammelte Magie für mächtige Effekte.",
    help_garden_desc: "Pflege deinen Garten für seltene Kräuter.",

    // Items
    item_wanderstock_title: "Wanderstock",
    item_wanderstock_desc: "Ein einfacher Stock aus Esche. Er trägt deine Last auf langen Wegen.",
    item_axe_title: "Steinaxt",
    item_axe_desc: "Ein robustes Werkzeug zum Holzfällen. Nicht schön, aber scharf.",
    item_pickaxe_title: "Spitzhacke",
    item_pickaxe_desc: "Damit lassen sich auch härtere Felsen bezwingen.",
    item_bow_title: "Jagdbogen",
    item_bow_desc: "Ein leichter, aber stabiler Bogen. Perfekt für die Jagd am Boden.",
    item_bread_title: "Frisches Brot",
    item_bread_desc: "Duftet herrlich und sättigt gut.",
    item_cookie_title: "Riesenkeks",
    item_cookie_desc: "Ein Geschenk des Bäckers. Unglaublich süß.",
    item_dried_meat_title: "Trockenfleisch",
    item_dried_meat_desc: "Zäh, aber nahrhaft. Perfekt für lange Wanderungen.",
    item_gourmet_meal_title: "Gourmet-Mahlzeit",
    item_gourmet_meal_desc: "Ein Festmahl, das Körper und Geist revitalisiert.",
    item_deed_title: "Landurkunde",
    item_deed_desc: "Ein offizielles Dokument, das deinen Besitz bestätigt.",
    item_book_knowledge_title: "Buch des Wissens",
    item_book_knowledge_desc: "Enthält die Geheimnisse des ersten Lichts.",
    item_scroll_title: "Alte Schriftrolle",
    item_scroll_desc: "Schwer zu entziffern, aber voller magischer Energie.",
    item_whetstone_title: "Wetzstein",
    item_whetstone_desc: "Hält deine Klingen scharf und deinen Willen hart.",
    item_arrowhead_title: "Pfeilspitze",
    item_arrowhead_desc: "Ein präzise gefertigtes Relikt des Jägers.",
    item_chisel_title: "Vergoldeter Meißel",
    item_chisel_desc: "Ein Werkzeug für wahre Meister der Formgebung.",
    item_astral_shards_title: "Astral-Splitter",
    item_astral_shards_desc: "Kristallisiertes Sternenlicht, gefüllt mit reiner Magie.",
    item_dream_dust_title: "Traumstaub",
    item_dream_dust_desc: "Ein glitzerndes Pulver, das die Grenzen der Realität lockert.",
