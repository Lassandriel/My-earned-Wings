export default {
  ui: {
    ...
    settings_show_particles: "Partikel-Effekte (Wetter & Feedback)",
    settings_system: "Speicher-Management & System",
    settings_reset: "Spiel komplett zurücksetzen",
    ...
    upgrades_desc: "Verwalte deine gesammelten Schätze und nutze Vorräte für deine weiteren Reisen.",
    ...
    nav_upgrades_desc: "Deine gesammelten Gegenstände und Ausrüstung. Manche können konsumiert werden.",
    ...
    ui_use: "Benutzen",
    ui_upgrades_empty: "Dein Besitz ist noch leer.",
    ui_salary: "Kosten",
    ui_yield: "Ertrag",
    status_idle: "Frei",
  ...
  logs: {
    ...
    garden_harvest_log: "Erfolgreich Kräuter geerntet. +{gain} Kräuter.",
