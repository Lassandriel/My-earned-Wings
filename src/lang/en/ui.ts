export default {
  ...
  loc_meadow: 'The Meadow',
  loc_mine: 'The Mine',
  loc_forest: 'The Forest',
  ...
  ui_magic_regen_passive: 'Passive Magic Regeneration',
  ui_study_efficiency: 'Study Efficiency',
  ui_fibers_yield: 'Fiber Yield',
  ui_clay_yield: 'Clay Yield',
