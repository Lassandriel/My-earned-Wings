export default {
  ...
  fail_satiation_loop: 'Too hungry for concentrated work!',
  ui_library: 'Library',
  townhall_registered: 'You are now officially registered as a resident!',
  townhall_tax_paid: 'You paid the administrative fee. An important step for your place in the village.',
  townhall_land_prepped: 'The survey of your building plot has been paid. You\'re almost there.',
  ui_read: 'Read on',
