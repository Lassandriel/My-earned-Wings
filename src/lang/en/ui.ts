export default {
  ...
  ui_continue_desc: 'Continue your journey from where you left off.',
  ui_new_game_desc: 'Start a new adventure on the ground of Draconia.',
  ui_settings_desc: 'Adjust sound, graphics, and language to your liking.',
  ui_quit_desc: 'Exit the game and return to the desktop.',
  ui_demo_badge: 'DEMO',
  ui_use: 'Use',
  ui_unknown: 'Unknown',
  loc_forest: 'Forest',
