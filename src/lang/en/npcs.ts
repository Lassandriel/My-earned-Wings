export default {
  ...
  // --- LORE BOOKS ---
  lore_1_step_1: 'Ignis Aurum, the Dragon Emperor, rules over Draconia with iron discipline and a heart of fire.',
  lore_1_step_2: 'Empress Amaterasu hails from the western Crystal Kingdom. Her solar grace warms the entire empire.',
  lore_1_step_3: 'Crown Princess Lunara is the eldest daughter. She commands the tides and the world of dreams.',
  lore_1_step_4: 'Prince Valerius serves as General. His earth magic allows him to mold even the hardest rock like wax.',
  lore_1_step_5: 'Zephyrion, the Wind Dragon, is known for his speed – and his secret passion for alchemy.',
  lore_1_step_6: 'Ryuga is the youngest member of the Imperial family. A small spark with immense potential.',
  lore_1_step_7: 'Lung Dragons are wingless sky-walkers. This rare form is almost exclusively reserved for the Imperial line.',
  lore_1_step_8: 'Dragonshifters possess two forms. The humanoid shape serves the practical everyday life in the cities.',
  lore_1_step_9: 'The Caldera is the seat of government. From here, the Emperor watches over the floating lands.',
  lore_1_step_10: 'Secretly, the Empress loves dramatic dime novels – a secret she strictly guards.',
  lore_2_step_1: 'Draconia consists of countless floating islands, held in the air by arcane currents.',
  lore_2_step_2: 'Deep below the islands stretches the Lava Sea, a glowing world full of dangers.',
  lore_2_step_3: 'In the far west lies the Crystal Kingdom, the home of the benevolent Grandpa-King.',
  lore_2_step_4: 'Luxana, the City of Light, is the cultural center of the empire and the seat of the scholars.',
  lore_2_step_5: 'The Emerald Forest is a gigantic jungle whose flora grows faster than one can watch.',
  lore_2_step_6: 'The Whispering Grove is a mystical place where the spirits of the ancestors live in the trees.',
  lore_2_step_7: 'The Tree of Life is the heart of Draconia. Its roots reach into the Aether itself.',
  lore_2_step_8: 'The Sun Plateau is the only place where the rare Celestial Berries thrive in unfiltered light.',
  lore_2_step_9: 'Obsidian Eels populate the lava flows. Their skin is as hard as volcanic glass.',
  lore_2_step_10: 'Titan Oxen are the indispensable helpers in the construction of the magnificent marble cities.',
};
