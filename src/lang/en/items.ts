export default {
  ...
  item_ghostwood_desc: 'Silvery shimmering wood from the Whispering Grove.',
  item_glowpollen_title: 'Glowpollen',
  item_glowpollen_desc: 'Glittering dust with magical resonance.',
  ...
  item_fibers_title: 'Plant Fibers',
  item_fibers_desc: 'Raw material for textile production.',
  item_resin_title: 'Tree Resin',
  item_resin_desc: 'Sticky substance, ideal as an adhesive or polish.',
  item_iron_parts_title: 'Iron Fittings',
  item_iron_parts_desc: 'Sturdy components for technical constructions.',
  item_clay_title: 'Moist Clay',
  item_clay_desc: 'Malleable earth, perfect for pottery and masonry.',
};
