export default {
  ...
  magic_limit_gain_desc: 'Expands your magical potential.',
  arcane_focus_cost_title: 'Focus Cost',
  arcane_focus_cost_desc: 'Cost for maintaining focus.',
  wood_title: 'Wood Capacity',
  stone_title: 'Stone Capacity',
  herbs_title: 'Herbs Capacity',
  meat_title: 'Meat Capacity',
  water_title: 'Water Capacity',
  books_title: 'Knowledge Capacity',
  energy_title: 'Maximum Energy',
};
