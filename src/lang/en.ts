...
const lang: Record<string, any> = {
  ui: {
    ...
    nav_tools_desc: 'Shape powerful tools from the gifts of nature.',
  ...
  logs: {
    ...
    fail_full_water: 'Water storage is full.',
  ...
  actions: {
    ...
    'act-garden-water': {
      title: 'Fetch Water',
      desc: 'Fetch fresh water from the well for your garden.',
    },
    'act-wanderstock': {
