export default {
  ...
  item_ghostwood_desc: 'Silbrig schimmerndes Holz aus dem Flüsterhain.',
  item_glowpollen_title: 'Leuchtpollen',
  item_glowpollen_desc: 'Glitzernder Staub mit magischer Resonanz.',
  ...
  item_fibers_title: 'Pflanzenfasern',
  item_fibers_desc: 'Rohmaterial für die Textilherstellung.',
  item_resin_title: 'Baumharz',
  item_resin_desc: 'Klebrige Substanz, ideal als Klebstoff oder Politur.',
  item_iron_parts_title: 'Eisenbeschläge',
  item_iron_parts_desc: 'Stabile Bauteile für technische Konstruktionen.',
  item_clay_title: 'Feuchter Ton',
  item_clay_desc: 'Formbare Erde, perfekt für Töpferwaren und Mauerwerk.',
};
