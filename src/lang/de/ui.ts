export default {
  ...
  ui_empty_collection:
    'Bisher wurden keine Geschichten gesammelt. Verrichte Taten, um sie hier niederzuschreiben.',
  ui_tab_all: 'Alle',
  ...
  item_crystal_apple_desc:
    'Ein glasartig schimmernder Apfel, der auf magische Weise nährt (+30 Sättigung, +20 Energie).',
  item_book_knowledge_title: 'Buch des Wissens',
  item_book_knowledge_desc:
    'Enthält die gesammelten Erfahrungen eines langen Lebens. Gewährt Studienerfahrung.',
  ...
  item_arcane_dust_desc:
    'Glitzerndes Pulver, das für höchste magische Konstruktionen benötigt wird.',
