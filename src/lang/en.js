export default {
  ui: {
    ...
    ui_tab_garden: "Garden",
    cat_log: "Chronicle",
    cat_log_enhanced: "Chronicle",
    cat_chronicle_world: "World Chronicle",
    ...
    objective_find_answers: "Find out who you are and grow stronger.",
    nav_story_tab: "Story",
    ...
    settings_show_juice: "Show Floating Text (+1 Wood)",
    settings_loop_mode: "Action Looping (Loop)",
    ...
    upgrades_desc: "Manage your collected treasures and use provisions for your further travels.",
    ...
    nav_upgrades_desc: "Your collected items and equipment. Some can be consumed.",
