...
export const MODIFIER_REGISTRY: Record<string, ModifierDefinition> = {
  ...
  wood_limit: { id: 'wood_limit', title: 'wood_title', desc: 'wood_limit_desc', baseValue: 50 },
  stone_limit: { id: 'stone_limit', title: 'stone_title', desc: 'stone_limit_desc', baseValue: 50 },
  herbs_limit: { id: 'herbs_limit', title: 'herbs_title', desc: 'herbs_limit_desc', baseValue: 20 },
  meat_limit: { id: 'meat_limit', title: 'meat_title', desc: 'meat_limit_desc', baseValue: 10 },
  water_limit: { id: 'water_limit', title: 'water_title', desc: 'water_limit_desc', baseValue: 10 },
  books_limit: { id: 'books_limit', title: 'books_title', desc: 'books_limit_desc', baseValue: 99 },
  energy_limit: { id: 'energy_limit', title: 'energy_title', desc: 'energy_limit_desc', baseValue: 100 },
  arcane_focus_cost: {
