export const baseConstruction = {
  ...
  'build-wood-storage-3': {
    ...
    requirements: {
      ...
      'flags.build-house': true,
      'flags.build-wood-storage-3': { op: '!=', val: true },
    },
  ...
  'build-stone-storage-3': {
    ...
    requirements: {
      ...
      'flags.build-house': true,
      'flags.build-stone-storage-3': { op: '!=', val: true },
    },
  ...
  'build-wood-storage-4': {
    ...
    requirements: {
      ...
      'flags.build-wood-storage-4': { op: '!=', val: true },
    },
    costs: { wood: 80, stone: 40 },
    image: 'img/addons/wood_1.webp',
    sfx: 'craft',
    onSuccess: [{ type: 'setFlag', flag: 'build-wood-storage-4', value: true }],
    maxCount: 1,
  ...
  'build-stone-storage-4': {
    ...
    requirements: {
      ...
      'flags.npc-blacksmith': true,
      'flags.build-stone-storage-4': { op: '!=', val: true },
    },
    costs: { wood: 40, stone: 80 },
    image: 'img/addons/stone_1.webp',
    sfx: 'craft',
    onSuccess: [{ type: 'setFlag', flag: 'build-stone-storage-4', value: true }],
    maxCount: 1,
