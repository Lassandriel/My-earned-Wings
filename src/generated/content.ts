...
export const TRANSLATIONS_GENERATED: Record<string, Record<string, Record<string, any>>> = {
  "de": {
    ...
    "npcs": {
      ...
      "npc_olie_luxana_summons": "Ein letzter Eintrag für Ihre Akte. Der Hof von Luxana hat nach Ihnen verlangt — namentlich, und nach Element. Eine Vorladung ans Hofmagier-Kollegium, unter Meister Elian persönlich. Wir schicken selten eine frische Absolventin direkt an den Hof. Glückwunsch — gleich doppelt, wie es scheint.",
      "npc_luxana_elian_1": "Ah — Sie sind es. Kommen Sie rein, Vorsicht beim dritten Stab, der beißt. Meister Elian. Vierzig Jahre lehre ich an diesem Hof — jedes Element außer Schatten. Und nun drückt man mir den ersten Schattenwandler in die Hand. Ehrlich gesagt habe ich keine Ahnung, wo ich anfangen soll; wir finden es gemeinsam heraus. Der alte Lord Caldwen liegt mir seit einer Woche in den Ohren — gehen Sie, zeigen Sie, was ein Schatten kann, was ein Drache nicht vermag.",
      "npc_luxana_elian_2": "Hauptmann. Sie bewachen Mauern — aller Ehren wert. Doch Sie wollen einsperren, was Sie sich nicht die Mühe gemacht haben zu verstehen. Diese vier werden für das sprechen, was dieser Schatten getan hat; lassen Sie sie... Ein Waffenstillstand also, Hauptmann. Gut. Und Sie — Sie können nun einen zweiten Schatten halten. Binden Sie ihn, wie Sariel es lehrte. Und dieses Bild im Archiv... gehen Sie behutsam. Luxana hat keine Antwort darauf, was Sie sind. Vielleicht hat irgendwo eine.",
      "npc_luxana_caldwen_1": "So. Der Hof-Schatten zum Vorzeigen. Eine Schatzkammer unter meinem Anwesen ist vollgelaufen — das Familiensiegel, drei Jahrhunderte alt, liegt hinter einem Eisengitter, zu eng für jede Klaue, in Wasser, in das kein Diener taucht. Man sagt, ein Schatten braucht weder Atem noch Breite. Greifen Sie durch. Holen Sie es herauf. Gelingt es, hört der Hof es von mir.",
      "npc_luxana_mirelle_1": "Leise — bitte, sie ist gerade erst eingeschlafen. Ein Schutztalisman ist unter die Matratze der Wiege gerutscht und summt nun, wo er schweigen sollte — doch das Holz trägt keine Hand, und Klauen würden sie wecken. Man sagt, Ihr Schatten wiegt nichts. Heben Sie ihn heraus. Wecken Sie meine Tochter nicht, und ich vergesse es nicht.",
      "npc_luxana_aurel_1": "Wunderbar, Sie sind da. Meine Soirée braucht etwas, das sie nie gesehen haben und nicht kaufen können. Man sagt, Schatten ist am stärksten, wo das Licht am hellsten brennt — also: ein lebendiges Schattenspiel über diese Wände, während der Saal in Gold steht. Geben Sie ihnen das, und Aurels Gunst öffnet Türen, die selbst Caldwens Name nicht vermag.",
      "npc_luxana_sylvaine_1": "Mondblume. Eine Berührung echten Tageslichts, und sie schwärzt für immer — doch sie muss am Mittag über den offenen Hof. Ich brauche Schatten, der mit ihr wandert und nicht einen Strahl durchlässt. Schatten gehört zum Licht; Sie sollten das beherrschen. Gehen Sie neben mir. Halten Sie es dunkel.",
      "npc_luxana_brannoc_1": "Das dritte Regal nicht anfassen, es ist tragend — und ich bin es auch. ...Wo haben Sie das her? Nein — sagen Sie es noch nicht. Vierzig Jahre hüte ich diese Rollen, und das passt in keine. Älter als der Hof, der diesen Raum gebaut hat. Kommen Sie wieder, wenn ich Zeit mit den alten Rollen hatte. Und erwähnen Sie es nicht bei den Vergoldeten oben.",
      "npc_luxana_brannoc_2": "Bei Morgengrauen gefunden, unter nichts abgelegt — hinter eine drei Jahrhunderte tote Volkszählung geklemmt, als hätte es jemand versteckt. Ich sage nur, was ich beweisen kann: Das ist alt, das ist Schatten, und das bist du. So etwas bleibt nicht geheim. Jemand mit einem Schwert wird davon hören, ehe die Tinte trocknet.",
      "npc_luxana_veyl_1": "Ich höre, das Archiv hat ein Bildnis zutage gefördert. Jahrhundertealt, und es trägt Ihr Gesicht. Ich habe nichts gegen Sie — verstehen Sie das. Aber Sie schlüpfen durch Gitter, heben, was nicht zu heben ist, stehen ungesehen in hellen Sälen, und ich bewache diesen Hof. Ich bringe es vor den Hof, unverblümt. Seien Sie da. Lieber hören Sie es von mir als aus einer Zelle.",
      "npc_luxana_pell_1": "Du bist der Schatten — alle reden. Ich bin Pell. Ich trage Sachen, meistens Geheimnisse. Willst du die echte Karte von hier? Caldwens Tresor ist nicht das Einzige von ihm, das unter Wasser steht. Der Vicomte schuldet seinem Schneider mehr, als sein Gut wert ist. Eine Page bemerkt niemand, also bemerke ich alles. Sei nett zu mir, und ich bin dir nützlich.",
      "npc_luxana_pell_2": "Das Bild, das der alte Archivar ausgegraben hat? Es bleibt nicht im Keller. Die Hauptmann war zweimal da und hat gefragt, was ein Schatten kann und was nicht. Veyl ist nicht grausam — das ist das Problem. Sie kommt dir gerade ins Gesicht, nach den Regeln. Also gib ihr keinen Grund. Du hast jetzt Freunde hier, auch kleine. Nutz uns.",
      "npc_luxana_voss_1": "Da sind Sie ja — der Schatten, nach dem alle schnappen. Ich habe das Haus, den Wein, auf dem Papier die richtigen Gäste. Was mir fehlt, ist der Anlass, und Sie, meine Liebe, sind ein Gesprächsthema. Einen Abend in meinem Salon. Tun Sie etwas Wunderbares, lassen Sie sie tuscheln. Nennen Sie Ihren Preis — Preise verstehe ich.",
      "npc_luxana_voss_2": "Sie wollen nicht? ...Wissen Sie, das ist das erste ehrliche 'Nein', seit ich mich durch jene Tür gekauft habe. Alle wollen etwas — Sie einfach nicht. Behalten Sie Ihren Schatten für sich. Doch das Wohlwollen einer emporgekommenen Händlerin ist die einzige wahre Währung an diesem Hof, und Sie haben meines. Ohne Vorstellung.",
      "npc_teacher_vandara_letter": "Bevor du gehst, {player}... das hier ist heute Morgen für dich angekommen. Aus Vandara — die Roségold-Akademie. Ich habe ihnen geschrieben, nachdem ich gesehen habe, wie ernsthaft du gelernt hast. Es ist nur eine Einladung, keine Verpflichtung. Aber wenn du wissen willst, was du wirklich bist, ist das vielleicht der richtige Weg.",
      "npc_vandara_olie_1": "Ah. Eine Neueinschreibung. Bitte nehmen Sie Platz — wir gehen das Notwendige der Reihe nach durch. Name, Herkunft, Element wenn bekannt... Unbekannt ist auch eine Antwort, keine Sorge.",
      "npc_vandara_olie_2": "So, die Einschreibegebühr. Fünfundzwanzig Splitter, einmalig. Die Akademie selbst ist kostenfrei — wir sind nicht das Kristallreich. Die Gebühr deckt nur den Verwaltungsaufwand und einen Schluck Tee, falls Sie länger warten müssen.",
      "npc_vandara_olie_3": "Hier ist Ihr Ausweis, ein dünnes, schweres Plättchen aus poliertem Roségold. Damit kommen Sie überall hin, wo Sie hindürfen — und ein paar Orte, wo Sie eigentlich nicht hindürften, aber die niemand kontrolliert. Ihre Mentoren: Lektor Ormias hält Drachenkunde, Doktor Quinell betreut die Arkanen Grundlagen, und Praktikerin Pamle gibt Alchemie — allerdings ergibt ihr Unterricht erst Sinn, wenn Sie sich ein Alchemielabor eingerichtet haben. Und da Sie Ihr Element nicht angeben konnten, schicke ich Sie zu Magistra Veyra. Sie führt die Diagnostik durch — keine Vorlesung, eine Sprechstunde. Die Beste der Stadt. Willkommen in Vandara, Studentin.",
      "npc_vandara_olie_4": "Ah. Das Element-Feld auf Ihrer Studierenden-Akte — ich habe es offengelassen, wie besprochen. Ich trage es jetzt nach. ...Schatten. Sub-Variante Licht. Vermerk: selten. So — ordnungsgemäß eingetragen. Die Archive schätzen Genauigkeit mehr als Neuheit; in diesem Fall bekommen sie beides. Machen Sie weiter, Studierende.",
      "npc_vandara_olie_5": "Ihre Akte ist vollständig. Drei Grundkurse, eine Element-Diagnostik, eine eigenständig organisierte Schatten-Praxis. Der Rat hat Sie zur Abschluss-Prüfung zugelassen. Hier ist Ihr Prüfungs-Pass — zeigen Sie ihn an jeder Station. Magistra Veyra führt die Praxis durch; sie erwartet Shadow Bind unter kontrollierten Bedingungen. Lektor Ormias prüft Sie mündlich in Drachenkunde, Doktor Quinell schriftlich in den Arkanen Grundlagen. Wählen Sie die Reihenfolge, dann kehren Sie zu mir zurück. Ich werde hier sein. Ich bin immer hier.",
      "npc_vandara_olie_6": "Alle drei Teile bestanden. Magistra Veyra notierte, ich zitiere: 'beispielhafte Kontrolle für eine:n Erstjähre:r:n Schattenwandler:in — zumindest die:der erste, die:der mir je begegnet ist.' Lektor Ormias: 'kannte alle sieben und benannte die achte unaufgefordert.' Doktor Quinell notierte nur 'zufriedenstellend' — das höchste Lob, das er je auf ein Abschluss-Formular geschrieben hat, in meinen vierzig Jahren. Hier ist Ihr Diplom: Die Roségold-Akademie von Vandara bestätigt, dass Sie den Grundkurs abgeschlossen haben. Glückwunsch, Absolvent:in. Die Akademie steht in Ihrer Schuld für eine:n Schattenwandler:in. Wohin Sie als Nächstes gehen, steht nicht in unserer Akte. Viel Glück, {player}.",
      "npc_vandara_kalre_1": "Du bist neu, ja? Sieht man. Kal're, aus dem Kristallreich. Windlinie. Habe ich schon gesagt, dass ich aus dem Kristallreich bin? Das tu ich gern, dann fragt niemand, warum ich Schuppen wie Glas habe. Hier, schnupper an den Ascheblumen. Vulkanstaub, und noch eine Sache, die du nicht benennen kannst. Wenn du jemals in ein Alchemielabor kommst, wirst du sie brauchen.",
      "npc_vandara_kalre_2": "Du bist wieder da! Gut, gut. Wirst sehen, in Vandara redet jeder mit jedem und alle wissen alles. Außer das, was sie nicht wissen sollen — da sind sie erstaunlich diszipliniert.",
      "npc_vandara_kalre_3": "Du fragst dich, ob ich dir traue? Genug. Hör mal — du kaufst andauernd meine Reagenzien, aber du hast nichts, wo du sie verarbeiten könntest. Die meisten Akademie-Studenten stellen sich ein kleines Alchemielabor ins Haus: zwei Regale, ein Kupferbecken, ein Abzug. Hier, die Skizze auf der Rückseite einer Tüte. Bring Holz und Stein mit — jetzt weißt du, wie's zusammengeht.",
      "npc_vandara_kalre_4": "Weißt du, was das Lustige an Vandara ist? Die Akademie tut so, als wäre sie das Herz der Stadt. Aber die echten Sachen passieren in den Hinterzimmern. Auf den Straßen. In den Katakomben unten. ...Sag's nicht weiter.",
      "npc_vandara_kalre_5": "Du bist jetzt einer von meinen Stammkunden. Wenn du je was Seltenes brauchst — was wirklich Seltenes — komm zu mir, bevor du irgendwen anders fragst. Ich finde es. Oder kenne jemanden, der's findet.",
      "npc_vandara_fafa_1": "Ein paar Splitter für eine alte Erddrachin? ...Danke, Kind. Du bist neu. Diese Stadt hat Namen, weißt du — nicht nur den, der oben am Tor steht. Komm wieder, ich erzähle dir einen.",
      "npc_vandara_fafa_2": "Vandara heißt 'Wandel'. Aber sie sagen dir nie, wer den Wandel will und wer ihn fürchtet. König Archivaris, der alte Knochenhalter, will alles so behalten wie's war. König-Rektorin Novia will alles neu. Die beiden streiten sich seit Jahren vor dem Kaiserhof — und solange sie streiten, regiert in Wahrheit niemand. Das macht Vandara... interessant. Komm wieder.",
      "npc_vandara_fafa_3": "Du kommst immer wieder. Das ist selten. Hör zu, Kind — die Studenten in den oberen Hörsälen lernen, was die Mentoren beibringen dürfen. Was sie wirklich wissen wollen, lernen sie woanders. Unter der Stadt. Komm noch einmal wieder, und ich zeige dir, wo.",
      "npc_vandara_fafa_4": "Diesmal keine Splitter. Komm — hinter dem Brunnen, dieser Gully. Schieb das Eisen beiseite; es bewegt sich wie ein Vorhang. Die Katakomben. Die alten Tunnel aus der Zeit vor dem Unaussprechlichen. Hier unten findest du die, die dir wirklich helfen können — wenn du den Mut hast herunterzukommen. Geh nicht alleine hin, bis du jemanden kennst, dem du dort vertraust. Aber geh.",
      "npc_vandara_veyra_1": "Willkommen, {player}. Olié hat Sie geschickt, ja? Gut. Das hier ist kein Unterricht — das ist eine Sprechstunde. Sie konnten ihm kein Element nennen; völlig in Ordnung. Wir finden es gemeinsam heraus. Die meisten Studenten wissen es schon von zuhause. Die paar, die nicht, sind oft die interessantesten.",
      "npc_vandara_veyra_2": "Zuerst die Anamnese. Erzählen Sie mir, was Sie zuhause gespürt haben — irgendetwas, das an Ihnen gezogen hat: Wärme in den Händen, Schwere in der Brust, Trockenheit im Hals wenn Sie wütend waren, ein Geräusch, das sonst niemand gehört hat. Auch nichts ist eine Antwort. Magie ist an Ihr Element gebunden; Sie können nicht wechseln, nur finden. Manche erkennen es in einem einzigen Moment, andere brauchen Übungen. Wir machen beides. Beim nächsten Mal beginnen wir mit den Resonanztests.",
      "npc_vandara_veyra_3": "Erster Resonanztest. Hände entspannt im Schoß, Handflächen nach oben. Nicht drücken, nicht greifen — lassen Sie Ihren Äther von selbst zur Ruhe kommen. ...Hm. Da ist etwas. Aber es liegt nicht sauber unter einer der Standard-Signaturen. Ich würde gerne nächste Sitzung eine ordentliche Batterie laufen lassen. Kommen Sie ausgeschlafen — auf einem ruhigen Körper läuft das glatter.",
      "npc_vandara_veyra_4": "Heute die Standard-Batterie. Fünf Gegenstände, ein Material pro Element — ein Stein, Wasser, eine Kerze, eine Feder, ein Spiegel. Berühren Sie jedes der Reihe nach; ich beobachte, was Ihr Äther tut. Es gibt keine richtige Antwort und keine falsche — auch 'nichts passiert' ist ein sauberes Ergebnis. Eins nur: nicht drücken. Der Äther lügt nicht, wenn man ihn ehrlich lässt. Lassen Sie sich Zeit. Wann immer Sie bereit sind.",
      "npc_vandara_veyra_5": "Sie sind wiedergekommen. Gut. Bitte setzen Sie sich. Die Lichtreaktion in Ihrer Batterie — das war kein Nullergebnis, aber auch keine saubere Licht-Signatur. Ich würde gerne einen kontrollierten Isolations-Test laufen lassen. Hände offen, nicht drücken, strecken Sie sich zur Kerze hin. ...Oh. Oh, {player}. Sie machen keinen Schatten — Sie ZIEHEN den Schatten an. Von der Wand. Von der Decke. Von mir. Sie sind kein Lichtwandler. Sie sind ein Schattenwandler. In vierzig Jahren Diagnostik habe ich noch nie einen gesehen.",
      "npc_vandara_veyra_6": "Schatten ist eine Sub-Variante von Licht, so wie Traum eine Sub-Variante von Gezeiten ist. Aber sie ist selten. Sehr selten — in vierzig Jahren habe ich noch nie eine gesehen. Ich kann Ihnen die Theorie geben, aber die Praxis... da bin ich nicht zuhause; ich kann Ihnen nicht beibringen, was ich selbst nie gefühlt habe. Es gab vor langer Zeit eine Kollegin hier. Sariel. Brillant. Auf dem Papier element-agnostisch, bis dey das selbst widerlegt hat. Wir haben uns aus den Augen verloren, als dey die Akademie verließ — vor vierzig Jahren, ungefähr. Ich weiß nicht, ob dey noch lehrt. Aber wenn Ihnen jemand die Praxis des Schattens beibringen kann, dann Sariel. Seien Sie vorsichtig, {player}. 'Schatten' klingt romantisch. Nicht jeder in dieser Stadt sieht es so.",
      "npc_vandara_veyra_7": "Sie sind mit dem Pass gekommen. Gut. Die Praxis ist kurz. Binden Sie einen Schatten an diese Kerze. Halten Sie ihn. Reden Sie mit mir über etwas Unrelatedes, dreißig Sekunden lang. Lassen Sie den Schatten nicht fallen, lassen Sie das Gespräch nicht versanden. Die Prüfung geht nicht um Stärke — sie geht darum, zwei Dinge gleichzeitig zu tun, ohne dass eines das andere verschluckt. ...Ja. Sauber gearbeitet. Vierzig Jahre und ein Erstes. Sie bestehen. Sagen Sie es Olié.",
      "vandara_trial_fire_dialog": "Wärme, ja — aber nichts antwortet darauf. Kein Feuer.",
      "vandara_trial_earth_dialog": "Schwer in der Hand, und... nichts regt sich. Keine Erde.",
      "vandara_trial_wind_dialog": "Fällt wie jede Feder — kein Heben, kein Zug. Kein Wind.",
      "vandara_trial_tide_dialog": "Nur dein Atem kräuselt das Wasser, mehr nicht. Keine Gezeiten.",
      "vandara_trial_light_dialog": "Da — Moment. Etwas hat sich bewegt, aber nicht im Spiegel... im Raum hinter dir. Das ist kein klares Licht. Komm zurück, sobald du kannst — ich will das genauer ansehen.",
      "npc_vandara_sariel_1": "Du bist viel zu laut für deine Größe, {player}. Lauf leiser in einem Tunnel — sonst hörst du nicht, wenn jemand direkt vor dir steht. Setz dich. Ich bin Sariel. Mach es dir bequem; die Kerze reicht für uns beide — ich brauche kein Licht.",
      "npc_vandara_sariel_2": "Du willst wissen, was Schatten ist. Ich habe die Bindung gehört, als du runtergekommen bist — billige Heftung, dünnes Papier, riecht nach der Archiv-Tinte der Akademie. Quinell benutzt immer noch denselben Drucker wie vor vierzig Jahren. Er hat dich hergeschickt, oder? Er hat dir sein Kapitel mitgegeben — Kapitel sechs, nehme ich an. Er saß zwei Jahre in meiner Klasse und schrieb alles mit, was ich sagte; das Kapitel ist seins. Ich habe in meinem ganzen Leben kein Wort geschrieben — ich bin blind, schon länger, als ich je hinter einem Pult stand. Es gab nichts abzuschreiben. Die Kurzfassung ist kurz: Schatten ist Licht, das genug Tiefe hat, einen Eigenwillen zu entwickeln. Ein Lichtwandler macht Helligkeit. Du machst Hohlräume — und die Hohlräume HÖREN dir zu. Verstanden? Nein? Gut — das war eine Lüge, um's kurz zu machen. Lies sein Kapitel trotzdem.\"",
      "npc_vandara_sariel_3": "Steh in das Licht. Jetzt streck die Hand aus — nicht zur Kerze, zum Schatten, den du wirfst. Ja, das geht. Fühl, nicht denk; Schatten sind dichter als normales Licht, spürbar, wenn man weiß wo... Ah. Da. Du hast ihn gegriffen — spürst du das Gewicht? Sehr gut. So habe ich das auch gelernt, mit zwölf, von einer Wandlerin im Smaragd-Wald. Auch blind, wie ich jetzt. Augen seien nur ein Weg von vielen, hat sie gesagt. Ich hab's erst geglaubt, als ich es musste.",
      "npc_vandara_pamle_1": "{player}, oder? Setz dich. Ich mach das schnell: ich bin Pamle, ich unterrichte Alchemie. Wir fangen mit zwei ganz simplen Rezepten an — Energietrank und Magietrank. Mehr als Kräuter, Wasser und ein bisschen Hitze brauchen die nicht. Geh nach Hause, bau dir die Werkstatt von Kal'res Bauplan, stell den Alchemietisch in dein Zimmer. Dann kannst du das brauen. Komm wieder, wenn du drei Energietränke gemacht hast — DREI, nicht zwei, nicht 'fast drei'. Dann zeige ich dir was Besseres.",
      "npc_vandara_pamle_2": "Drei Energietränke, ja? Gut. Ich verkaufe die übrigens an die Erstsemester für gutes Geld, falls du dich gefragt hast — Bildung ist nicht umsonst. Jetzt zu Tier zwei: Wachpollen-Tee, Regeneration über Zeit. Und Funkenlicht-Phiole — die wirst du noch zu schätzen wissen, glaub mir; Sariel unten in den Katakomben hat sie früher kistenweise bestellt. ...Üb. Bring mir drei Funkenlicht-Phiolen, wenn du soweit bist.",
      "npc_vandara_pamle_3": "Funkenlicht-Phiolen. Drei. Schön — sauber gearbeitet; du verstehst die Dosierung. Letzte Runde. Arkanwasser ist Standard für jeden Studenten, der Magie betreibt. Und Aschebrand-Tinktur — die ist meine eigene Erfindung, aus den Pollen einer Asche-Weide. Macht dich für zwei Minuten zur Holzfäll-Maschine; du wirst nicht glauben, wie viele Aufträge die Akademie dafür von den Bauunternehmen bekommt. Komm einmal noch wieder, dann hab ich dir alles beigebracht, was ich grad anbieten kann.",
      "npc_vandara_pamle_4": "So. Das war's mit den Grundlagen — du beherrschst jetzt die sechs Basis-Rezepte. Was kommt, wird schwerer: Sternenfrüchte sind selten, Glut-Lotos noch seltener, und einige Rezepte verlangen Reagenzien, die nur Gewitter-Seraphe einsammeln können. Aber bis dahin hast du noch was zu tun. Geh und braue. Wenn ich je was Neues unterrichte, weißt du, wo du mich findest. Ach — und Pamle ist nicht mein voller Name, ich hab nie einen bekommen. Spar dir die Frage.",
      "npc_vandara_pamle_5": "Aha. Das hat sich rumgesprochen — du bist die Schatten-Person. Heißt, ich sollte vielleicht überlegen, welche Reagenzien für deine Sorte Sinn machen. Asche von erloschenen Kerzen, Spiegelscherben-Staub, sowas. Ich sag Bescheid, wenn mir was einfällt. Und erwarte keinen Rabatt — seltenes Element heißt nicht pleite. Jetzt verzieh dich, ich muss der nächsten Gruppe Tier-drei beibringen.",
      "npc_vandara_sariel_4": "Du bist jetzt nicht ausgebildet. Du bist aufgewacht — das ist was anderes. Was du brauchst, lernst du jetzt von selbst. Komm wieder, wenn du etwas Komplizierteres versuchen willst; bring mir eine Schale Wasser mit, dann zeige ich dir, wie du einen Schatten holen lässt, der sie hält, während du andere Sachen machst. Das ist der praktische Teil. Vierzig Jahre Lehrkraft, und ich verspreche immer noch das Spannende für die nächste Stunde.",
      "npc_vandara_sariel_5": "Du hast die Schale mitgebracht. Gut — stell sie ab, dort, auf den Boden zwischen uns. So. Der Trick, den ich dir versprochen habe. Schatten sind nicht umsonst; sie sind du, ein Teil von dir, den du in die Welt schiebst, und einen zu binden kostet deine eigene Magie, fortlaufend, solange du ihn draußen hältst. Wähl eine Aufgabe — irgendetwas, das du mit den Händen machst: Hacken, Brauen, Wasser schöpfen. Schau auf deinen Schatten, dann bitte ihn, die Aufgabe statt deiner zu machen. Nicht laut — mit dem gleichen wortlosen Druck, mit dem du letztens den Schatten von der Wand gegriffen hast... Ja. Genau das. Jetzt kannst du etwas anderes tun, während der Schatten weitermacht. Magie läuft die ganze Zeit ab, vergiss das nicht — geht sie zur Neige, lässt der Schatten los. Einen Schatten, eine Aufgabe; mehr kann ich dir nicht beibringen. Aufmerksamkeit weiter zu spalten ist die Arbeit der nächsten vierzig Jahre, nicht der nächsten Stunde. Geh. Mach zwei Dinge gleichzeitig — das ist das Nächste, was die meisten von uns je dem Freisein kommen.",
      "npc_vandara_ormias_1": "Setz dich, Studierende. Drachenkunde, Grundkurs. Sieben Hauptarten kennen wir: Großdrachen, Wyvern, Lindwürmer, Amphithere, Leviathane, Seraphe, Fae. Dazu noch die kaiserlichen Lung-Drachen — eine Ausnahme, die nehmen wir uns zuletzt vor. Eine pro Sitzung. Keine Abkürzungen. Und merk dir das absolut Wichtigste über sie alle: sie haben alle Flügel. ...Ja. Alle.",
      "npc_vandara_ormias_2": "Großdrachen. Die Hüter der Reiche. Das Brot-und-Butter-Volk aus dem Kristallreich im Westen. Kräftiger Körperbau, vier Beine, ein Paar breite Lederschwingen, oft eine gepanzerte Schwanzspitze und große Hörner. Die häufigste Art mit Abstand — viele Spätzünder; Flügel kommen manchmal erst mit zwanzig oder dreißig. Statistisch bist du höchstwahrscheinlich einer von diesen. Geduld. Sie kommen.",
      "npc_vandara_ormias_3": "Wyvern. Die Jäger der Lüfte. Nur zwei Hinterbeine — die Vorderbeine sind in der Evolution mit den Flügeln verschmolzen. Schnelle, muskulöse Flieger, meist mit einem Giftstachel oder einer schweren Keule am Schwanzende. Die Sturm-Wyvern haben Flügelkanten so scharf, dass sie den Wind wie Klingen schneiden. Häufig im westlichen Tiefland. Du wüsstest, wenn du einer wärst — die fliegen jung.",
      "npc_vandara_ormias_4": "Lindwürmer. Die Erdgebundenen. Meinesgleichen. Massiver Körper, nur zwei Vorderbeine, die hintere Hälfte ist eine lange Schlange, die wir hinter uns herziehen. Flügel haben wir auch, aber schwerfällig — in der Luft sind wir nicht graziös. Wir graben, wir klettern, wir sind langsam und stur. Zwei Hauptlinien: Magma-Lindwürmer, Schuppen wie glühende Lava, leben nahe dem Lavameer; und Sumpf-Lindwürmer, Schuppen wie Algen und Rinde, getarnt im Urwald von Smaragd. Von Fremden manchmal zu westlichen Drachen geworfen. Wir sind östlich. Bring das nicht durcheinander.",
      "npc_vandara_ormias_5": "Amphithere. Die gefiederten Schlangen. Keine Gliedmaßen — nur ein langer Schlangenkörper und ein einziges Paar gewaltiger, prächtiger Federschwingen, die übrigens magische Energie speichern können. Selten. Schön — das gebe sogar ich zu. Zwei bekannte Sub-Arten: Traum-Amphithere, deren Flügelschläge Illusionsnebel erzeugen; und Sonnen-Amphithere, goldene Federn, die bei Bedrohung in eine blendende Licht-Explosion entladen können. Magistra Veyra ist eine. Sag ihr nicht, dass ich gesagt habe, sie sei schön.",
      "npc_vandara_ormias_6": "Leviathane. Die Herrscher der Extreme. Sie leben dort, wo sonst niemand kann. Gezeiten-Leviathane beherrschen die schwebenden Wasserinseln und Wasserwege — sehnige Schwingen, die unter Wasser als Flossen dienen, feine Kiemenschlitze, absolute Herrscher der Strömungen. Magma-Leviathane auf den untersten, heißesten Inseln über dem Lavameer — massive gepanzerte Flügel, obsidianbeschichtete Schuppen, Lungen die superheiße Gase filtern. Einmal im Jahr treffen sie sich an den Lavafällen und handeln. Die angesehensten Handwerker im Reich.",
      "npc_vandara_ormias_7": "Seraph-Drachen. Die Himmelsstürmer. Schlank, aerodynamisch, vier bis sechs schmale Flügel übereinander gestapelt. Sie leben dort, wo die Luft so dünn ist, dass ein Großdrache das Bewusstsein verlieren würde, und lachen über unsere Stürme — was wir Hurrikan nennen, ist ihre Morgenbrise. Erwarte nicht, einen zu sehen; sie kommen fast nie runter. Wenn doch, sei höflich.",
      "npc_vandara_ormias_8": "Fae-Drachen. Die Smaragd-Weber. Die Kleinsten. Libellenflügel, Chamäleon-Tarnung, ursprünglich aus dem tiefen Urwald von Smaragd. Heute zwei Kulturen: die wilden Wald-Fae, die noch immer in der Rinde verschwinden, und die Stadt-Fae, die sich an das urbane Leben angepasst haben und prächtige, knallbunte Schuppen tragen, weil sie in der Stadt nichts mehr fürchten müssen. Wenn du jemals einen in einer Taverne triffst, gib ihm einen Drink aus. Bester Klatsch in Draconia.",
      "npc_vandara_ormias_9": "Und zum Schluss — die Lung-Drachen. Die Himmelsläufer. Schlangenartig, flügellos, vier Beine mit scharfen Klauen, charakteristische Bartfäden am Kopf. Sie fliegen rein durch Magie — keine Flügel. Die einzige Ausnahme zu meiner Eröffnungsregel. Und bevor du fragst: ja, ich habe gesehen, dass du keine Flügel hast. Komm nicht auf Ideen. Lung-Drachen sind ein absoluter genetischer Sonderfall — sie kommen ausschließlich in der kaiserlichen Blutlinie vor, und selbst dort existieren aktuell nur zwei. Kaiser Ignis Aurum und Prinz Ryuga. Das ist die Liste. Du bist höchstwahrscheinlich ein Spätzünder-Großdrache. In achtzig Prozent der Fälle. Geduld.",
      "npc_vandara_ormias_10": "Aha. Ich hab's gehört. Gerüchte laufen schnell durch die Akademie-Korridore, vor allem wenn's um das Unmögliche geht. Erlaub mir einen Moment professionelle Verlegenheit: Ich hab dir mit einiger Sicherheit gesagt, du seist höchstwahrscheinlich ein Spätzünder-Großdrache. Anscheinend lag ich daneben — wobei, in aller Fairness, auch nicht ganz daneben. Schatten ist eine Sub-Variante des Lichts. Lichtwandler sind Großdrachen. Also technisch, statistisch, halten die achtzig Prozent immer noch. Knapp. Ich würde Kapitel Zwei meines Buches sehr gerne aktualisieren. Komm gelegentlich wieder vorbei — ich werde neue Fragen haben, und die Fragen sind meistens interessanter als die Antworten.",
      "npc_vandara_ormias_11": "Also gut. Mündliche Prüfung — ich sage die Frage, du sprichst die Antwort. Keine Notizen. Versuch, mich nicht anzuhusten. ...Nenne die sieben Hauptarten der Drachenwandler, in beliebiger Reihenfolge, mit je einem unterscheidenden Merkmal. ...Gut, gut, gut. Und die achte. Ja, die achte — wir beide wissen, dass es eine gibt. Nenn sie, und das eine Merkmal, das sie von allen anderen unterscheidet. ...Lung-Drachen. Flügellos. Genau. Du bestehst. Sag's Olié. Und komm später wieder für ein längeres Gespräch. Ich habe einige Fragen aktualisiert.",
      "npc_vandara_quinell_1": "Willkommen. Arkane Grundlagen ist die langweiligste Vorlesung, die Sie an dieser Akademie hören werden. Und die wichtigste. Wenn Sie nicht verstehen, was Magie IST, werden Sie sie niemals präzise anwenden. Sie werden zaubern wie ein Hund schwimmt — funktional, hässlich, ineffizient. Sieben Sitzungen: die Definition, vier Gesetze, und die Ausnahmen, die sie rahmen. Keine Abkürzungen. Wir beginnen mit der Definition.",
      "npc_vandara_quinell_2": "Definition. Magie ist die Manipulation des Äthers durch einen drachischen Geist. Beachten Sie: der Äther — nicht 'Energie', nicht 'Kraft'. Beachten Sie: drachischer Geist — nicht drachischer Körper. Der Körper ist ein Werkzeug, der Geist ist der Zauberer. Wenn Sie aus diesem gesamten Kurs nur zwei Wörter behalten, dann diese: Äther. Geist. Alles andere folgt daraus.",
      "npc_vandara_quinell_3": "Erstes Gesetz. Das Drei-Komponenten-Gesetz. Jede Handlung von Magie braucht drei Elemente gleichzeitig. Element — Ihre angeborene Ausrichtung, das eine Element, das Ihre Blutlinie Ihnen gibt. Wille — der geübte Fokus Ihres drachischen Geistes. Substrat — das physische Material, durch das die Wirkung manifestiert: die eigene Form, ein Werkzeug, die Luft selbst. Drei. Immer drei. Wer sie nicht im Kopf trennen kann, scheitert an jedem höheren Kurs dieser Akademie.",
      "npc_vandara_quinell_4": "Zweites Gesetz. Das Gesetz der Element-Bindung. Sie können Ihr Element nicht 'wählen'. Sie können nicht 'wechseln'. Was Ihnen Ihre Blutlinie bei der Geburt gegeben hat, ist, was Sie für den Rest Ihres Lebens zaubern werden. Ein Feuerwandler, der versucht Wasser zu bändigen, produziert nichts — kein schwaches Wasser, gar kein Wasser. Gelegentlich kommen Studierende mit der Überzeugung an, sie könnten sich ein zweites Element antrainieren. Können sie nicht. Geben Sie sich diese Illusion jetzt auf.",
      "npc_vandara_quinell_5": "Drittes Gesetz. Das Erhaltungsgesetz. Magie kommt nicht aus dem Nichts. Was Sie in die Welt schicken, kommt aus Ihnen. Persönliche Energie raus, magischer Effekt rein — eins zu eins, keine Ausnahmen in der Buchhaltung. Der Äther ist ein Medium, keine Quelle. Wer Ihnen 'freie Magie' verspricht, verkauft Ihnen Betrug oder einen Salon-Trick. Wahrscheinlich beides.",
      "npc_vandara_quinell_6": "Viertes Gesetz. Das Erschöpfungs-Gesetz. Das ist das Gesetz, das Studierende am häufigsten missverstehen. Erschöpfung ist kein Versagen. Erschöpfung ist das Maß Ihrer Wirkung. Müde heißt: die Magie ist geschehen. Nicht müde heißt: sie ist nicht geschehen. Wer ohne Erschöpfung zaubert, hat nichts getan. Wer sich beim Zaubern einer Teetasse erschöpft, hat eine echte Teetasse gezaubert. Wenden Sie beide Hälften dieses Gesetzes an, und Sie zaubern bereits besser als drei Viertel der Studierenden in diesem Saal.",
      "npc_vandara_quinell_7": "Letzte Sitzung. Ausnahmen. Vier Gesetze. Sie sind korrekt. Sie sind auch nur einen Ausnahmefall davon entfernt, falsch zu sein — sehr wenige, sehr selten; in achtzig Prozent der Fälle gelten die Gesetze restlos. Die restlichen zwanzig Prozent sind das, woraus Doktorarbeiten gemacht werden. Es gab hier einmal eine Lehrkraft. Sariel. Element-agnostisch laut Akten, bis dey das selbst widerlegt hat. Kapitel sechs dieses Skripts ist meines — ich habe es aus deren Vorlesungen mitgeschrieben. Dey ist blind, schon länger, als ich dey kenne; das Schreiben war immer mein Teil der Abmachung. Dey las vor, ich notierte. Das Kapitel ist die einzige Abhandlung, die ich über Schatten als Sub-Variante des Lichts kenne. Niemand hat je einen dokumentierten Schatten-Wandler kennengelernt, der bereit war, sich untersuchen zu lassen. Dey verließ die Akademie vor vierzig Jahren. Ob dey noch lebt, weiß ich nicht. Lesen Sie das Kapitel. Wenn Sie je Belege für einen aktuellen Schatten-Wandler finden, schreiben Sie die Arbeit. Widmen Sie sie angemessen.",
      "npc_vandara_quinell_8": "Ich habe gehört. ...Sariel hatte also Recht. Die Akten waren falsch; das Vorlesungs-Kapitel war richtig. Ich werde es im Archiv vermerken. Wenn Sie jemals — wenn Sie wieder zu dey hinunter gehen — sagen Sie Sariel, dass das Kapitel immer noch funktioniert. Vierzig Jahre später bestehen die Studierenden es immer noch. Dey erinnert sich vielleicht nicht an mich, aber ich habe mich an dey erinnert. Das ist alles. Gehen Sie. Studieren Sie. Wenden Sie die Gesetze an. Sie werden jedes einzelne brauchen.",
      "npc_vandara_quinell_9": "Setzen Sie sich. Schreiben Sie. Nennen Sie jedes der vier Gesetze beim Namen plus einen Satz mit Substanz. Sie können sich angemessen Zeit lassen. Benutzen Sie den Stift, nicht den Finger. ...Zufriedenstellend. Kehren Sie zu Olié zurück. Wenden Sie sie ehrlich an. Die Gesetze interessieren sich nicht, ob Sie sich an sie erinnern. Nur, ob Sie sie respektieren.",
      "npc_vandara_gate_guard_admit": "Erstes Mal in Vandara, ja? Akademie-Einladungen sehen wir alle paar Wochen. Du wirst dich noch wundern, wie groß diese Stadt unter der Oberfläche ist. ...Willkommen, {player}. Geh ruhig — die Mentoren werden dir den Rest erklären.",
      "npc_vandara_gate_guard_respect": "Du hast die Stadt unter der Stadt gesehen. Das ändert einen. Die meisten kommen mit dem Brief, gehen mit dem Brief, sehen nur die Hälfte. Du gehörst jetzt zu denen, die beide Hälften kennen. Pass auf dich auf, {player}.",
      "npc_vandara_korren_1": "Du bist runtergekommen. Gut — Nachrichten reisen, sogar bis hier. Ich bin Korren. Ich — naja. Ich arbeite für König Archivaris. Nicht offiziell, verstehst du. Offiziell bin ich Studierender im dritten Jahr, der 'mit Drachenkunde zurückgefallen' ist. Inoffiziell bin ich hier unten, um etwas zu beweisen. Echo-Beschwörung: alte Gegenstände erinnern sich, und ich wecke sie gerade genug, um zu flüstern. Die Akademie hält das für Nekromantie. Ist es nicht — keine Seele, nur Resonanz. Aber die Akademie kümmert sich nicht um Feinheiten, wenn sie die Mathematik nicht sieht. Hilf mir — ich brauche einen Faden deiner Magie, um das Echo zu verankern. Fünf Fäden, mehr nicht. Der Ring wird mir verraten, wie der Schmied gestorben ist, der ihn gemacht hat. Kleine Sache. Ein Beweis.",
      "npc_vandara_korren_2": "Ich hab gehört, Iska hat es geschafft. Die Wyvern mit dem Puppentrick — hat einen Teelöffel zehn Sekunden lang stehen lassen. Niedlich. Animation ist das Einfache; jeder kann Materie anstupsen, damit sie zuckt. Was ich mache, ist schwerer — ich reiche durch die Zeit. Aber der Korridor hat über Iska geredet, nicht über mich, und das heißt, mein König verliert das heutige Argument. Wir gehen größer. Ich habe eine Münze, Militär-Ausgabe, aus dem Krieg vor vierzig Jahren. Sie hat einen Mann sterben sehen. Wenn ich sie dazu bringe, mir zu sagen WIE, kann die Akademie den Echo-Trick nicht mehr Salon-Magie nennen. Zehn Fäden. Jetzt.",
      "npc_vandara_korren_3": "Iska animiert eine Leichen-Puppe. Eine KLEINE, aber trotzdem. Die ganze Stadt wird das bis Ende der Woche wissen, und wenn Archivaris bis dahin keine Antwort hat, gewinnt Novias Fraktion diese Runde am Hof. Also wecken wir jetzt eine echte Erinnerung. Eine Scherbe aus dem kaiserlichen Archiv — frag nicht, wie ich sie bekommen habe. Sie hat — egal was sie gesehen hat. Zwanzig Fäden Magie, und wir werden wissen, ob die offiziellen Akten die tatsächlichen Akten sind. ...Es hat funktioniert. Oh, es hat funktioniert. Wart ab, bis ich das aufschreibe. Wart ab, bis—",
      "npc_vandara_iska_1": "Hi, hi, setz dich, mach den Kreis nicht kaputt. Iska. Wind-Linie. Ich sollte eigentlich nicht hier sein, ich sollte bei Pamles Tier-drei-Vorlesung sein, aber Pamle unterrichtet BRAUEN und ich will Sachen BEWEGEN. Pass auf den Löffel. Fünf Fäden Magie von dir, mehr brauch ich nicht. Der Löffel steht auf. Vielleicht. Beim letzten Mal ist er aufgestanden und hat mich gestochen, also — geh in Deckung. König Novia würde das lieben. Die Alten sagen, Materie ist träge. Materie ist nicht träge. Materie ist nur schüchtern.",
      "npc_vandara_iska_2": "Korren hat das Ring-Ding gemacht — hat ihn flüstern lassen. Flüstern. Jeder kann flüstern. Ich will BEWEGEN. Ich verdrahte Runen ins Uhrwerk — nicht nur zucken, laufen. Drei Schritte. Der Hof wird Korren aus dem Raum lachen, wenn sie das sehen. Zehn Fäden, bitte, schnell — ich hab die Geometrie im Kopf und verliere sie, wenn du mich warten lässt.",
      "npc_vandara_iska_3": "Korren geht ins kaiserliche Archiv. Wusstest du das? Ich weiß es — die Wände hier unten hören mit. Das Ding hier? Frag nicht. Geliehen, aus einem alten Grab, seit hundert Jahren niemandem mehr wichtig. Zwanzig Fäden, und ich lasse sie einen Kreis laufen. Wenn ich das schaffe, gehören die Hörsäle für ein Jahrzehnt Novias Fraktion. ...JA. Das. Hast du das gesehen? Sie hat geschaut. Sie hat GESCHAUT—",
      "npc_vandara_daven_1": "Sie. Studierende. Mir wurde berichtet, dass Sie hier unten zu Besuch waren. Ich bin Marschall Daven, Vollstreckung des Rats von Vandara. Ich verhafte Sie nicht — noch nicht. Ich frage, weil Sie die beiden gesehen haben: Korren der Echo-Beschwörer und Iska die Animatorin. Was haben die vor? Sprechen Sie offen. Der Rat hat Beschwerden von den Agenten beider Könige bekommen, was selten genug ist, um eigene Beweisqualität zu haben. Sagen Sie mir, was Sie wissen. Über Ihre eigene Rolle reden wir danach.",
      "npc_vandara_daven_2": "Ein Echo aus einer kaiserlichen Archiv-Scherbe. Eine animierte Figur aus grabgeraubtem Knochen. Beide an Ihrer eigenen Magie verankert. Das ist das Muster, das ich alle fünfzehn, zwanzig Jahre sehe: zwei Studierende, jeder für einen König. Sie fangen klein an, sie überbieten sich gegenseitig, und irgendwann geht jemand ans kaiserliche Archiv oder an ein Grab. Sie haben das nicht angefangen. Sie haben allerdings den magischen Faden geliefert, der beide über die Linie geschoben hat. Ich schätze Ihre Kooperation. Eine letzte Frage — zeigen Sie mir, wo die zwei arbeiten. Genau wo. Der Rat bevorzugt eine saubere Festnahme.",
      "npc_vandara_daven_3": "Zwei weitere Wachen treten hinter Sie, ruhig und professionell; beide Studierende scheinen auf ihre eigene Art gewartet zu haben. Iska grinst Sie im Abgehen an: \"Danke für den Boost, Kind! Sag Pamle, mir tut die Brau-Stunde leid!\" Erledigt. Der Rat wird sie in einem Monat anhören — wahrscheinlich für zwei Jahre suspendiert, danach wieder an der Akademie, mit je einem anderen Mentor. Kein Gefängnis. Sie sind Kinder. Ihre Rolle wird in der Akte als 'kooperierende Zeug:in' vermerkt — großzügiger als 'Mittäter:in', was es ebenso gut sein könnte. Gehen Sie vorsichtig, Studierende. Glauben Sie nicht alles, was Ihnen die Agenten eines Vassals erzählen. Und wenn das nächste Mal jemand in den Katakomben Sie nach Magie fragt — sagen Sie nein. Einmal. Sagen Sie nein."
    },
    "resources": {
      "energy": "Energie",
      "magic": "Magie",
    ...
    "ui": {
      ...
      "ui_luxana-court": "Drachenwandlern geholfen",
  ...
  "en": {
    ...
    "npcs": {
      ...
      "npc_olie_luxana_summons": "One last item for your file. The court at Luxana has asked for you — by name, and by element. A summons to the Hofmagier collegium, under Meister Elian himself. We don't often send a fresh graduate straight to court. Congratulations — twice over, it seems.",
      "npc_luxana_elian_1": "Ah — you're the one. Come in, mind the third staff, it bites. Meister Elian. Forty years I've taught at this court — every element but shadow. And now they hand me the first shadow-shifter. Truth be told, I've no idea where to begin; we'll work it out together. Old Lord Caldwen's been hounding me for a week — go, see what a shadow can do that a drake cannot.",
      "npc_luxana_elian_2": "Captain. You guard walls — admirable. But you would cage what you haven't troubled to understand. These four will speak for what this shadow has done; let them... A truce, then, Hauptmann. Good. As for you — you can hold a second shadow now. Bind it as Sariel taught you. And that picture in the archive... go carefully. Luxana has no answer for what you are. Perhaps somewhere does.",
      "npc_luxana_caldwen_1": "So. The court's pet shadow. A vault beneath my estate flooded — the family signet, three centuries old, sits behind an iron grate too narrow for any claw, in water no servant will dive. They say a shadow needs neither breath nor width. Reach through. Bring it up. Succeed, and the court hears of it from me.",
      "npc_luxana_mirelle_1": "Softly — please, she's only just asleep. A warding charm slipped beneath the cradle's mattress, and now it hums where it should be silent — but the wood won't bear a hand, and claws would wake her. They say your shadow weighs nothing. Lift it out. Don't wake my daughter, and I won't forget it.",
      "npc_luxana_aurel_1": "Marvellous, you came. My soirée needs something they've never seen and cannot buy. They say shadow is strongest where the light burns brightest — so: a living shadow-play across these walls while the room blazes gold. Give them that, and Aurel's favour opens doors even Caldwen's name cannot.",
      "npc_luxana_sylvaine_1": "Moonbloom. One touch of true daylight and it blackens forever — yet it must cross the sunlit court at noon. I need shade that moves with it and lets not one ray through. Shadow belongs to light; you of all things should manage it. Walk beside me. Keep it dark.",
      "npc_luxana_brannoc_1": "Don't touch the third rack, it's load-bearing — and so am I. ...Where did you get that? No — don't tell me yet. Forty years I've kept these rolls, and this fits none of them. Older than the court that built this room. Come back when I've had time with the old rolls. And don't mention it to the gilded ones upstairs.",
      "npc_luxana_brannoc_2": "Found it near dawn, filed under nothing — wedged behind a census three centuries dead, as if someone hid it. I'll say only what I can prove: this is old, it is shadow, and it is you. Word like this doesn't keep. Someone with a sword will hear of it before the ink dries.",
      "npc_luxana_veyl_1": "I hear the archive turned up a portrait. Centuries old, wearing your face. I've nothing against you — understand that. But you slip through bars, lift what cannot be lifted, stand unseen in bright rooms, and I guard this court. I'll put it before the court, plainly. Be there. Better you hear it from me than from a cell.",
      "npc_luxana_pell_1": "You're the shadow — everyone's talking. I'm Pell. I carry things, mostly secrets. Want the real map of this place? Caldwen's vault isn't the only thing of his that's underwater. The Vicomte owes his tailor more than his estate's worth. Nobody notices a page, so I notice everything. Be kind to me and I'll be useful.",
      "npc_luxana_pell_2": "That picture the old archivist dug up? It's not staying in the cellar. The captain's been by twice, asking what a shadow can and can't do. Veyl's not cruel — that's the trouble. She'll come at you straight, by the rules. So don't give her a reason. You've got friends here now, even small ones. Use us.",
      "npc_luxana_voss_1": "There you are — the shadow everyone's gasping about. I have the house, the wine, the right guests on paper. What I lack is occasion, and you, my dear, are a talking point. One evening in my salon. Do something marvellous, let them whisper. Name your fee — I do understand fees.",
      "npc_luxana_voss_2": "You won't? ...Do you know, that's the first honest 'no' I've had since I bought my way through that door. They all want something — you just don't. Keep your shadow to yourself, then. But a jumped-up merchant's goodwill is the only true currency at this court, and you have mine. No performance required.",
      "npc_teacher_vandara_letter": "Before you go, {player}... this came for you this morning. From Vandara — the Rose Gold Academy. I wrote to them after seeing how seriously you studied. It's just an invitation, not an obligation. But if you want to find out what you really are, this might be the way.",
      "npc_vandara_olie_1": "Ah. A new enrolment. Please have a seat — we'll go through the necessary in order. Name, origin, element if known... Unknown is also an answer, don't worry.",
      "npc_vandara_olie_2": "Now, the enrolment fee. Twenty-five shards, one-off. The academy itself is free — we are not the Crystal Realm. The fee just covers paperwork and a sip of tea should you have to wait.",
      "npc_vandara_olie_3": "Here is your ID, a thin plaque of polished rose gold. It gets you anywhere you're allowed — and a few places you're not, but nobody checks. Your mentors: Lector Ormias holds Dragon Studies, Doctor Quinell handles Arcane Foundations, and Practitioner Pamle gives Alchemy — though her class only makes sense once you've arranged a workshop yourself. And since you couldn't state your element, I'll send you to Magistra Veyra. She handles the diagnostics — not a class, a consultation. The best in the city. Welcome to Vandara, student.",
      "npc_vandara_olie_4": "Ah. The element field on your student record — I left it blank, as we discussed. I'll fill it in now. ...Shadow. Sub-variant Light. Note: rare. There — properly recorded. The archives appreciate accuracy more than novelty; in this case they get both. Carry on, student.",
      "npc_vandara_olie_5": "Your file is complete. Three basic courses, one element diagnostic, one independently arranged shadow-practice. The Council has authorised you to sit your graduation examination. Here is your exam permit — show it at each station. Magistra Veyra runs the practical; she expects Shadow Bind under controlled conditions. Lector Ormias examines you orally on Dragon Studies, Doctor Quinell in writing on Arcane Foundations. Take them in any order, then return to me. I will be here. I am always here.",
      "npc_vandara_olie_6": "All three sections passed. Magistra Veyra noted, and I quote: 'exemplary control for a first-year shadow-shifter — at least, the first I have ever met.' Lector Ormias: 'remembered all seven and named the eighth without prompting.' Doctor Quinell noted only 'satisfactory' — the highest praise he has written on a graduation form in my forty years. Here is your diploma: the Rose Gold Academy of Vandara confirms you have completed the basic curriculum. Congratulations, graduate. The academy is in your debt for one shadow-shifter. Where you go next is not in our file. Good luck, {player}.",
      "npc_vandara_kalre_1": "You're new, yeah? Easy to tell. Kal're, from the Crystal Realm. Wind line. Did I already mention I'm from the Crystal Realm? I like saying it — then nobody asks why my scales are like glass. Here, sniff these ash flowers. Volcanic dust, and one other thing you can't quite name. If you ever set foot in an alchemy lab, you'll need them.",
      "npc_vandara_kalre_2": "You're back! Good, good. You'll see — in Vandara everyone talks to everyone and everyone knows everything. Except the things they shouldn't; on those they're surprisingly disciplined.",
      "npc_vandara_kalre_3": "Wondering if I trust you yet? Enough. Listen — you keep buying my reagents, but you've nowhere to use them. Most academy students put a small alchemy laboratory in their home: two shelves, a copper basin, a flue. Here's the sketch, on the back of this wrapper. Bring the wood and stone — you'll know how to put it together now.",
      "npc_vandara_kalre_4": "Know what's funny about Vandara? The academy acts like it's the heart of the city. But the real things happen in the back rooms. The streets. The catacombs below. ...Don't repeat that.",
      "npc_vandara_kalre_5": "You're a regular now. If you ever need anything rare — really rare — come to me before you ask anyone else. I'll find it. Or I'll know someone who will.",
      "npc_vandara_fafa_1": "A few shards for an old earth-dragon? ...Thank you, child. You're new. This city has names, you know — not just the one above the gate. Come back, and I'll tell you one.",
      "npc_vandara_fafa_2": "Vandara means 'change'. But they never tell you who wants the change and who fears it. King Archivaris, the old keeper of bones, wants everything kept as it was. King-Rectoress Novia wants everything made new. They've argued before the imperial court for years — and while they argue, no one truly rules. That makes Vandara... interesting. Come back.",
      "npc_vandara_fafa_3": "You keep coming back. That's rare. Listen, child — the students in the upper halls learn what the mentors are allowed to teach. What they really want to know, they learn elsewhere. Beneath the city. Come back one more time, and I'll show you where.",
      "npc_vandara_fafa_4": "No shards this time. Come — behind the fountain, that storm drain. Slide the iron aside; it moves like a curtain. The catacombs. The old tunnels from before the Unspeakable. Down here you'll find the ones who can really help you, if you've the courage to descend. Don't go alone until you know someone down there you can trust. But go.",
      "npc_vandara_veyra_1": "Welcome, {player}. Olié sent you, yes? Good. This isn't a class — it's a consultation. You couldn't give him an element; that's quite alright. We'll find out together. Most students already know from home. The few who don't are often the most interesting.",
      "npc_vandara_veyra_2": "First, the anamnesis. Tell me what you've felt at home — anything that pulled at you: warmth in your hands, weight in your chest, dryness in your throat when angry, a sound no one else heard. Even nothing is an answer. Magic is bound to your element; you can't switch, only find. Some recognise it in a single moment, others need exercises. We'll do both. Next time we begin the resonance tests.",
      "npc_vandara_veyra_3": "First resonance test. Hands relaxed in your lap, palms up. Don't push, don't reach — let your aether settle on its own. ...Hm. There is something. But it doesn't sit cleanly under any of the standard signatures. I'd like to run a proper battery next session. Come back rested — it goes smoother on a calm body.",
      "npc_vandara_veyra_4": "Today, the standard battery. Five objects, one material per element — a stone, water, a candle, a feather, a mirror. Touch each in turn; I'll watch what your aether does. There's no right answer and no wrong one — even 'nothing happens' is a clean result. One thing only: don't push. The aether doesn't lie when you let it be honest. Take your time. Ready when you are.",
      "npc_vandara_veyra_5": "You came back. Good. Please sit. The light reaction during your battery — that was not a null result, but not a clean light signature either. I'd like a controlled isolation test. Hands open, no pushing, reach toward the candle. ...Oh. Oh, {player}. You are not casting a shadow — you are PULLING the shadow toward you. From the wall. From the ceiling. From me. You are not a light-shifter. You are a shadow-shifter. In forty years of diagnostics I have never seen one.",
      "npc_vandara_veyra_6": "Shadow is a sub-variant of Light, the way Dream is a sub-variant of Tide. But it is rare. Very rare — in forty years I have never seen one. I can give you the theory, but the practice... I'm out of my depth; I cannot teach you what I have never felt. There was a colleague here, a long time ago. Sariel. Brilliant. Element-agnostic on paper, until they disproved it themselves. We lost touch when they left the academy — forty years ago, give or take. I don't know whether they still lecture. But if anyone can teach you the practice of shadow, it is Sariel. Be careful, {player}. 'Shadow' sounds romantic. Not everyone in this city sees it that way.",
      "npc_vandara_veyra_7": "You came with the permit. Good. The practical is short. Bind a shadow to this candle. Hold it. Talk to me about something unrelated for a count of thirty. Don't let the shadow drop, don't let the conversation falter. The exam isn't about strength — it's about doing two things at once without one swallowing the other. ...Yes. Cleanly done. Forty years, and a first. You pass. Tell Olié.",
      "vandara_trial_fire_dialog": "Warmth, yes — but nothing answers it. No fire.",
      "vandara_trial_earth_dialog": "Heavy in the hand, and... nothing stirs. No earth.",
      "vandara_trial_wind_dialog": "It falls like any feather — no lift, no pull. No wind.",
      "vandara_trial_tide_dialog": "Only your breath troubles the water, nothing more. No tide.",
      "vandara_trial_light_dialog": "There — wait. Something moved, but not in the mirror... in the room behind you. That's not clean light. Come back as soon as you can — I want a closer look.",
      "npc_vandara_sariel_1": "You're far too loud for your size, {player}. Walk softer in a tunnel — otherwise you won't hear when someone's standing right in front of you. Sit. I'm Sariel. Make yourself comfortable; the candle's plenty for both of us — I don't need any light.",
      "npc_vandara_sariel_2": "You want to know what shadow is. I heard the binding when you came down — cheap stitch, thin paper, smells of the academy's archive ink. Quinell still uses the same printer he did forty years ago. He sent you, didn't he. He gave you that chapter of his — chapter six, I'd assume. He sat in my class two years scratching down everything I said; the chapter is his. I've never written a word in my life — I've been blind since before I ever stood at a lectern. There was nothing to copy. The gist is short: shadow is light with enough depth to develop a will of its own. A light-shifter makes brightness. You make hollows — and the hollows LISTEN. Got it? No? Good — that was a lie to keep it short. Read his chapter anyway.\"",
      "npc_vandara_sariel_3": "Stand in the light. Now reach out — not toward the candle, toward the shadow you cast. Yes, that works. Feel, don't think; shadows are denser than ordinary light, palpable when you know where... Ah. There. You grabbed it — feel the weight? Very good. Same way I learned it, at twelve, from a shifter in the Emerald Forest. Blind too, like me now. She said eyes are just one way of many. Took me until I had to before I believed it.",
      "npc_vandara_pamle_1": "{player}, right? Sit. I'll make this quick: I'm Pamle, I teach alchemy. We start with two very simple recipes — energy potion and magic potion. Nothing more than herbs, water, and a bit of heat. Go home, build the workshop from Kal're's blueprint, place the alchemy table in your room. Then you can brew them. Come back when you've made three energy potions — THREE, not two, not 'almost three'. Then I'll show you something better.",
      "npc_vandara_pamle_2": "Three energy potions, yes? Good. I sell them to the first-years for decent money, by the way, in case you were wondering — education isn't free. Now, tier two: Wakeful Pollen Tea, regen over time. And Spark Light Vial — you'll learn to appreciate that one, trust me; Sariel down in the catacombs used to order them by the crate. ...Practice. Bring me three Spark Light Vials when you're ready.",
      "npc_vandara_pamle_3": "Spark Light Vials. Three. Nice — cleanly done; you understand the dosing. Last round. Arcane Water is standard for any student who casts magic. And Ash Burn Tincture — that's my own invention, made from Ash Willow pollen. Turns you into a logging machine for two minutes; you wouldn't believe how many orders the academy gets from construction firms for it. Come back once more, and I'll have taught you everything I currently offer.",
      "npc_vandara_pamle_4": "So. That's the basics — you handle the six base recipes. What's next gets harder: Star Berries are rare, Ember Lotus rarer still, and some recipes demand reagents only Storm Seraphs can gather. But until then you've got plenty to do. Go and brew. If I ever teach anything new, you know where to find me. Oh — and Pamle isn't my full name, I never had one. Save the question.",
      "npc_vandara_pamle_5": "So. Word's around — you're the shadow one. Means I should probably think about what reagents make sense for your sort. Ash from extinguished candles, mirror-shard dust, that kind of thing. I'll let you know if I come up with something. And don't expect a discount — rare element doesn't mean broke. Now scoot, I've got tier-three brewing to teach the next batch.",
      "npc_vandara_sariel_4": "You're not trained now. You're awake — that's something else. What you need from here, you'll learn yourself. Come back if you want something more complicated; bring a bowl of water, and I'll show you how to fetch a shadow that holds it while you do other things. That's the practical part. Forty years teaching, and I still promise the interesting stuff for next session.",
      "npc_vandara_sariel_5": "You brought the bowl. Good — set it down, there, on the floor between us. Now, the trick I promised. Shadows aren't free; they are you, a part you push out into the world, so binding one costs your own magic, continuously, for as long as you keep it out. Pick a task — anything you do with your hands: chopping, brewing, drawing water. Look at your shadow, then ask it to do that task instead of you. Not aloud — the same wordless push you used when you grabbed the shadow off the wall... Yes. That. Now you can do something else while the shadow carries on. Magic drains the whole time, mind — when it runs out, the shadow lets go. One shadow, one task; that's the cap I can teach you. Splitting your attention further is for the next forty years, not the next hour. Go. Do two things at once — it's the closest most of us ever come to being free.",
      "npc_vandara_ormias_1": "Sit, student. Dragon Studies, basic course. We know seven main types: Great Dragons, Wyverns, Lindwurms, Amphitheres, Leviathans, Seraphs, Fae. Plus the imperial Lungs — an exception we'll get to last. One per session. No shortcuts. And remember the single most important thing about every one of them: they all have wings. ...Yes. All of them.",
      "npc_vandara_ormias_2": "Great Dragons. Guardians of the Realms. The bread-and-butter people from the Crystal Realm in the west. Strong build, four legs, a pair of broad leather wings, often an armoured tail-tip and large horns. The most common type by far — many late bloomers; wings don't always come in until twenty or thirty. Statistically you are most likely one of these. Patience. They'll come.",
      "npc_vandara_ormias_3": "Wyverns. Hunters of the skies. Two hindlegs only — their front limbs fused with the wings during evolution. Fast, muscular flyers, usually with a venom-stinger or a heavy club at the tail. The Storm-Wyverns have wing-edges so sharp they cut wind like blades. Common in the western lowlands. You'd remember if you were one — they fly young.",
      "npc_vandara_ormias_4": "Lindwurms. The Earth-Bound. My kind. Massive body, only two forelegs, the rear half a long serpent we drag behind us. Wings we have, but heavy — we are not graceful in the air. We dig, we climb, we are slow, and we are stubborn. Two main lines: Magma Lindwurms, scales like glowing lava, living near the magma sea; and Swamp Lindwurms, scales like algae and bark, blending into the Emerald jungle. Foreigners sometimes lump us in with western dragons. We are eastern. Don't confuse us.",
      "npc_vandara_ormias_5": "Amphitheres. The Feathered Serpents. No limbs at all — just a long serpentine body and a single pair of enormous, magnificent feathered wings, which can store magical energy. Rare. Beautiful — even I admit it. Two sub-types we know of: Dream-Amphitheres, whose wing-strokes spin illusion-mist; and Sun-Amphitheres, golden feathers that detonate into a blinding flash when threatened. Magistra Veyra is one. Don't tell her I said she's beautiful.",
      "npc_vandara_ormias_6": "Leviathans. Rulers of the Extremes. They live where no one else can. Tide-Leviathans command the floating water islands and the sea routes — sinewy wings doubling as fins underwater, fine gill-slits, absolute lords of the currents. Magma-Leviathans on the lowest, hottest islands above the lava sea — massive armoured wings, obsidian-plated scales, lungs that filter superheated gas. Once a year they meet at the lava-falls and trade. The most prestigious craft-folk in the empire.",
      "npc_vandara_ormias_7": "Seraph Dragons. The Sky-Stormers. Slender, aerodynamic, four to six narrow wings stacked one above the other. They live where the air is thin enough that a Great Dragon would lose consciousness, and they laugh at our storms — what we call a hurricane is their morning breeze. Don't expect to see one; they almost never come down. If you do, be polite.",
      "npc_vandara_ormias_8": "Fae Dragons. The Emerald Weavers. The smallest. Dragonfly wings, chameleon camouflage, originally from the deep Emerald jungle. Two cultures now: the wild Forest-Fae who still vanish into bark, and the City-Fae who've adapted to urban life and grow brilliant, gaudy scales because nothing in town wants to eat them anymore. If you ever meet one in a tavern, buy them a drink. Best gossip in Draconia.",
      "npc_vandara_ormias_9": "And finally — the Lung Dragons. The Sky-Walkers. Serpentine, wingless, four legs with sharp claws, characteristic beard-whiskers at the head. They fly by pure magic — no wings at all. The single exception to my opening rule. And before you ask: yes, I noticed you have no wings. Don't get excited. Lung Dragons are an absolute genetic outlier — they only appear in the imperial bloodline, and even there currently only two exist. Emperor Ignis Aurum and Prince Ryuga. That is the list. You are most likely a late-blooming Great Dragon. In eighty percent of cases. Patience.",
      "npc_vandara_ormias_10": "Ah. I heard. Word travels fast in academy corridors, especially when it involves the impossible. Allow me one moment of professional embarrassment: I told you, with some confidence, that you were most likely a late-blooming Great Dragon. I appear to have been incorrect — though, in fairness, also not entirely wrong. Shadow is a sub-variant of Light. Light-shifters are Great Dragons. So technically, statistically, the eighty percent still holds. Just. I would very much like to update Chapter Two of my book. Come and visit again sometime — I'll have new questions for you, and the questions are usually more interesting than the answers.",
      "npc_vandara_ormias_11": "Right. Oral exam — I'll say the prompt, you speak the answer. No notes. Try not to cough on me. ...Name the seven main types of dragon-shifter, in any order, with one distinguishing feature each. ...Good, good, good. And the eighth. Yes, the eighth — we both know there is one. Name it, and the one identifying feature that disqualifies all the others. ...Lung Dragons. Wingless. Exactly. You pass. Tell Olié. And come back later for a longer conversation — I've updated some questions.",
      "npc_vandara_quinell_1": "Welcome. Arcane Foundations is the most boring lecture you will hear at this academy. And the most important. If you don't understand what magic IS, you will never apply it precisely — you will cast like a dog swims: functional, ugly, inefficient. Seven sessions: the definition, four laws, and the exceptions that frame them. No shortcuts. We begin with the definition.",
      "npc_vandara_quinell_2": "Definition. Magic is the manipulation of the aether through a draconic mind. Note: the aether — not 'energy', not 'force'. Note: draconic mind — not draconic body. The body is a tool, the mind is the caster. If you remember nothing else from this entire course, remember those two words. Aether. Mind. Everything else follows.",
      "npc_vandara_quinell_3": "First law. The Three-Component Law. Every act of magic requires three elements at once. Element — your innate alignment, the one element your bloodline grants you. Will — the trained focus of your draconic mind. Substrate — the physical material through which the effect manifests: your own form, a tool, the air itself. Three. Always three. Whoever cannot separate them in their mind will fail every advanced course at this academy.",
      "npc_vandara_quinell_4": "Second law. The Element-Binding Law. You cannot 'choose' your element. You cannot 'switch'. Whatever your bloodline gave you at birth is what you will cast for the entirety of your life. A fire-shifter who tries to wield water produces nothing — not weak water, no water at all. Students occasionally arrive convinced they can train themselves into a second element. They cannot. Disabuse yourself now.",
      "npc_vandara_quinell_5": "Third law. The Conservation Law. Magic does not come from nothing. What you send into the world comes from you. Personal energy out, magical effect in — one to one, no exceptions to the accounting. The aether is a medium, not a source. Anyone who tells you they have found 'free magic' is selling you a fraud or performing a parlour trick. Probably both.",
      "npc_vandara_quinell_6": "Fourth law. The Exhaustion Law. This is the law students misunderstand most. Exhaustion is not failure. Exhaustion is the measure of your effect. Tired means the magic happened. Untired means it did not. Whoever casts without exhaustion has done nothing. Whoever exhausts themselves casting a teacup has cast a real teacup. Apply both halves of that rule and you'll already cast better than three quarters of the students sitting in this hall.",
      "npc_vandara_quinell_7": "Final session. Exceptions. Four laws. They are correct. They are also exceptions away from being incorrect — very few, very rare; in eighty percent of cases the laws hold without remainder. The remaining twenty are what doctoral theses are made of. There was a colleague here once. Sariel. Element-agnostic, the records said, until they themselves disproved that. Chapter six of these notes is mine — I transcribed it from their lectures. They are blind, have been since before I knew them; the writing was always my part of the arrangement. They lectured, I wrote. The chapter is the only treatise I know on Shadow as a sub-variant of Light. No one has ever met a documented shadow-shifter willing to be examined. They left the academy forty years ago. Whether they still live, I do not know. Read the chapter. If you ever find evidence of a current shadow-shifter, write the thesis. Dedicate it appropriately.",
      "npc_vandara_quinell_8": "I heard. ...Sariel was correct, then. The records were wrong; the lecture chapter was right. I will note it in the archives. If you ever — when you go back down to them — tell Sariel that the chapter still works. Forty years on, students still pass it. They may not remember me, but I have remembered them. That is all. Go. Study. Apply the laws. You will need every one of them.",
      "npc_vandara_quinell_9": "Sit. Write. State each of the four laws by name and one sentence of substance. You may take as long as you require within reason. Use the pen, not your finger. ...Satisfactory. Return to Olié. Apply them honestly. The laws do not care whether you remember them. Only whether you respect them.",
      "npc_vandara_gate_guard_admit": "First time in Vandara, eh? We see academy invitations every few weeks. You'll be surprised how big this city is below the surface. ...Welcome, {player}. Go on through — the mentors will explain the rest.",
      "npc_vandara_gate_guard_respect": "You've seen the city beneath the city. That changes a person. Most come with the letter, leave with the letter, see only half. You belong to those who know both halves now. Take care of yourself, {player}.",
      "npc_vandara_korren_1": "You came down. Good — word travels, even to here. I'm Korren. I work for King Archivaris — not officially, you understand. Officially I'm a third-year student who 'fell behind on Dragon Studies'. Unofficially I'm down here proving something. Echo-summoning: old objects remember, and I bring them up just enough to whisper. The academy thinks it's necromancy. It isn't — there's no soul, just resonance. But the academy doesn't care about distinctions when it can't see the math. Help me — I need a thread of your magic to anchor the echo. Five threads' worth, that's all. This ring will tell me how the smith who made it died. Small thing. Proof.",
      "npc_vandara_korren_2": "I heard Iska did it. The Wyvern with the puppet — made a teaspoon stand up by itself for ten seconds. Cute. Animation is the easy thing; anyone can poke matter and make it twitch. What I'm doing is harder — I'm reaching across time. But the corridor talked about Iska, not me, and that means my king loses today's argument. We're going bigger. I have a coin, military issue, from the war forty years ago. It's seen a man die. If I can make it tell me HOW, the academy can't call the echo trick parlour magic any more. Ten threads. Now.",
      "npc_vandara_korren_3": "Iska is animating a corpse-doll. A SMALL one, but still. The whole city will hear about that by the end of the week, and if Archivaris doesn't have an answer by then, Novia's faction wins this round in court. So we're going to wake a real memory. A shard from the imperial archive — don't ask how I got it. It saw — never mind what it saw. Twenty threads of magic, and we'll know whether the official records are the actual records. ...It worked. Oh, it worked. Wait until I write this up. Wait until—",
      "npc_vandara_iska_1": "Hi, hi, sit down, don't break my circle. Iska. Wind line. I'm not supposed to be here — I'm supposed to be at Pamle's tier-three lecture, but Pamle teaches BREWING and I want to make things MOVE. Watch the spoon. Five threads of magic from you, that's all I need. The spoon stands up. Maybe. Last time it stood up and stabbed me, so — stand back. King Novia would love this. The old people say matter is inert. Matter is not inert. Matter is just shy.",
      "npc_vandara_iska_2": "Korren did the ring thing — made it whisper. Whisper. Anyone can whisper. I want to MOVE. I'm wiring runes into a clockwork — not just twitch, walk. Three steps. The court will laugh Korren out of the room when they see this. Ten threads, please, fast — I've got the geometry held in my head and I'll lose it if you make me wait.",
      "npc_vandara_iska_3": "Korren is going to the imperial archive. Did you know that? I know it — the walls down here listen. This thing? Don't ask. Borrowed, from an old grave a hundred years past anyone caring. Twenty threads, and I make it walk a circle. If I do, Novia's faction owns the lecture halls for a decade. ...YES. That. Did you see that? It looked. It LOOKED—",
      "npc_vandara_daven_1": "You. Student. I've been told you've been visiting down here. I'm Marshal Daven, Council-of-Vandara enforcement. I'm not arresting you — yet. I'm asking because you've seen them: Korren the echo-summoner and Iska the animator. What are they up to? Speak plainly. The Council has had complaints from both kings' agents, which is rare enough to be its own kind of evidence. Tell me what you can. We can speak about your own role afterwards.",
      "npc_vandara_daven_2": "An echo from an imperial archive shard. An animated figure made from grave-robbed bone. Both anchored to your own magic. This is the pattern I've seen every fifteen or twenty years: two students, one for each king. They start small, they escalate against each other, and somebody eventually goes to the imperial archive or to a grave. You did not start this. You did, however, contribute the magical thread that pushed both of them past the line. I appreciate your cooperation. One last question — show me where they work. Exactly where. The Council prefers a clean arrest.",
      "npc_vandara_daven_3": "Two guards step in behind them, quiet and professional; both students seem to have been waiting. Iska grins at you on her way out: \"Thanks for the boost, kid! Tell Pamle I'm sorry about the brewing class!\" It's done. The Council will hear them in a month — probably suspended two years, then back at the academy after that with a different mentor each. No prison. They are children. Your role will be noted in the file as 'cooperating witness'. That is more generous than 'accomplice', which it could just as easily be. Walk carefully, student. Don't believe everything every Vassal's agent tells you. And the next time someone in the catacombs asks for your magic — say no. Just once. Say no."
    },
    "resources": {
      "energy": "Energy",
      "magic": "Magic",
    ...
    "ui": {
      ...
      "location_luxana_name": "Luxana",
      "chapter_luxana": "Luxana",
      "ui_luxana-court": "Dragon-shifters helped",
      "npc_luxana_elian_name": "Meister Elian",
      "npc_luxana_caldwen_name": "Lord Caldwen",
      "npc_luxana_mirelle_name": "Lady Mirelle",
      "npc_luxana_aurel_name": "Vicomte Aurel",
