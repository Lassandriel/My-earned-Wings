...
graph TD
    ...
    Tent --> Storage["Storage (+25 Wood/Stone Limit)"]
...
* **Storage**: Starting capacity is **25** for wood and stone. Building Wood/Stone storage expands this to **50**.
* **Milestone**: Obtaining the Land Deed and building the House (40 Wood / 40 Stone). Unlocking the House further expands limits to **75/125**.
...
* **Arcane Focus**: automating tasks using Magic Drain (3/s) instead of Energy.
* **Milestones**:
...
* **Interaction**: All social interactions are bond-driven. Salary-based companion logic has been removed to favor a loyalty-based system.
