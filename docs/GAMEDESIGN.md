...
`My-earned-Wings` is an atmospheric, narrative-driven incremental simulation. The player takes the role of a wingless wanderer in a world of flying beings clled *Dragonshifters*. The focus lies on grounded survival, community building, and uncovering the mystery of one's own origin.
